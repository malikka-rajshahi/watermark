...
#    python experiments/c4-experiment.py --save $save/$lang-m-15-mod-b1-TEST.p --n $n --method gumbel_mod --batch_size $batch --m 15 --rt_translate --model $model --language $lang --beta 0.1 --buffer_tokens $buffer --seed $seed
