...
def generate(model,prompts,vocab_size,n,m,seeds,key_func,sampler,random_offset=True,token_embeddings=None):
    ...
    for seed in seeds:
        ...
        if token_embeddings is None:
            ...
            xi,pi,token_embeddings,beta = key_func(generator,n,vocab_size, token_embeddings)
        print("set xi and pi")
