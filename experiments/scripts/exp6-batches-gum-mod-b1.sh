...
python experiments/c4-experiment.py --save $save/$lang-m-$m-mod-b1.p --n $n --method gumbel_mod --batch_size $batch --m $m --rt_translate --model $model --language $lang --beta 0.1 --buffer_tokens $buffer --seed $seed
